...
public class CustomStatusNotiRequest implements Request {

    private static final Logger logger = LoggerFactory.getLogger(CustomStatusNotiRequest.class);
    ...
    public CustomStatusNotiRequest() {
    }
    ...
    public boolean equals(Object o) {
        ...
        CustomStatusNotiRequest that = (CustomStatusNotiRequest) o;
