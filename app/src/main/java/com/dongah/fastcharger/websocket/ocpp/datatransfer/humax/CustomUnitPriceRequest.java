...
public class CustomUnitPriceRequest implements Request  {

    private static final Logger logger = LoggerFactory.getLogger(CustomUnitPriceRequest.class);
    ...
    public boolean equals(Object o) {
        ...
        CustomUnitPriceRequest that = (CustomUnitPriceRequest) o;
